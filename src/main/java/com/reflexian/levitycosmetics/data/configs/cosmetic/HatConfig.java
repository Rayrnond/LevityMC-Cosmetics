        ...
        return Arrays.asList(
                LHat.builder()
                        ...
                        .itemStack(new ItemBuilder(Material.TNT)
                                ...
                                .amount(1)
                                .lore("<color:gray> > <color:yellow>%glow%","<color:gray> > <color:yellow>%chatcolor%","<color:gray> > <color:yellow>%crown%","<color:gray> > <color:yellow>%tabcolor%"," ", "<color:yellow>Click to equip this hat!")
